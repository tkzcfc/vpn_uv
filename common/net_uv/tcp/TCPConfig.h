...
#define TCP_HEARTBEAT_TIMER_DELAY (1000)		// 心跳检测定时器间隔
#define TCP_HEARTBEAT_CHECK_DELAY (2000)	// 心跳检测时间
#define TCP_HEARTBEAT_MAX_COUNT_SERVER 15	// 心跳不回复最大次数(服务端)
#define TCP_HEARTBEAT_MAX_COUNT_CLIENT 10	// 心跳不回复最大次数(客户端)
